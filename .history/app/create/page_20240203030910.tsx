...
function page() {
  ...
  return (
    <div>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col    max-w-4xl mx-auto py-12 gap-2'>
            <div>
                <ImagePic value={state.imageSrc}  onChange={(value) => setCustomValue('imageSrc',value)}   />
            </div>
            <div className='w-[300px] sm:[500px] flex flex-col items-center justify-center'>
            <div className='p-3 '>
