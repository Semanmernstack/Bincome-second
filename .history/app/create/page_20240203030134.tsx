...
function page() {
  ...
  return (
    <div>
        ...
        <form onSubmit={handleSubmit} className='w-[300px] sm:[w-500px] h-[700px] mx-auto py-12 gap-2'>
            <div>
            ...
            <button className='flex w-full items-center justify-center p-2 bg-green-300' type='submit'>Emergency </button>
